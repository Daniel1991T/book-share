          ...
          {profilesLink.map((link) => (
            ...
            >
              <TabsTrigger
                ...
                value={link.value}
                className="w-auto data-[state=active]:border-b-2 data-[state=active]:border-como rounded-none md:w-44 gap-2 data-[state=active]:text-como data-[state=active]:font-bold stroke-1 !data-[state=active]:stroke-2 transition-all duration-300 ease-linear"
              >
                <link.imgURL />
